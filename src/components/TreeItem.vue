...
<template>
  <div class="tree-item__container flex items-center space-x-2">
    <div v-if="item.children" class="tree-item__toggle cursor-pointer" @click="toggleChildren">
      <ArrowIcon
        :class="[
    ...
    <div
      ...
      :class="[
        ...
        item.checked === 'indeterminate' ? 'tree-item__checkbox--indeterminate' : ''
      ]"
  ...
  <div :class="[item.children ? 'pl-6 py-2 space-y-2' : '']" v-if="item.children && showChildren">
    <tree-item
